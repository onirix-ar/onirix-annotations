...
```html
<head>
    <script src="https://unpkg.com/@onirix/annotations-module@2.0.6/dist/ox-annotations-module.umd.js"/>
</head>
```
...
```js
import OnirixAnnotationsModule from "https://unpkg.com/@onirix/annotations-module@2.0.6/dist/ox-annotations-module.esm.js";
```
