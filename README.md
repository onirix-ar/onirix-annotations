...
![Version](https://img.shields.io/badge/version-2.0.7-blue.svg?cacheSeconds=2592000)
...
```html
<head>
    <script src="https://unpkg.com/@onirix/annotations-module@2.0.7/dist/ox-annotations-module.umd.js"/>
</head>
```
...
```js
import OnirixAnnotationsModule from "https://unpkg.com/@onirix/annotations-module@2.0.7/dist/ox-annotations-module.esm.js";
```
